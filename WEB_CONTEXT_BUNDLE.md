...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.65"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-v1",
      "problem_contract_sha256": "9beae984c880a6c2cd1f9d44508eebc62892c51a8be820c2706bee86fd870104",
      "problem_id": "problem:um-kou-21.65-kourovka-notebook-problem-21.65-06413528",
      "route_id": "route:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-source-fidelity-01",
      "graph_id": "graph:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Suppose that $\\phi$ is an automorphism of a finite soluble group $G$. Must $G$ contain a subgroup of index bounded in terms of $|\\phi|$ and $|C_G(\\phi)|$ whose Fitting height is bounded (a) in terms of $|\\phi|$? (b) or even in terms of the composition length of $\\langle\\phi\\rangle$?"
          },
          "statement_sha256": "d7aece12b9376e1c5b1060ef77b0852a51b42dc1f973a80a5f7c62e5c5cfdbfb"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-root",
      "route_id": "route:um-kou-21.65-kourovka-notebook-problem-21.65-06413528-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.65-6db8e430a0fa",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.65"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
